...
public class databasec {
    ...
    static int setAdmissionDetails(String p_name, String p_fname, String p_mname, String p_email, String p_adharno, String p_phoneno, String p_address,String p_date, String p_course) {
        
        int i=0;
        try
        {
             Connection con = databasec.getConnection();
            String query= "insert into admission (Student Name,Father Name,Mother Name,Email Id,Aadhar No,Phone No,Address,Dob,Course) values(?,?,?,?,?,?,?,?,?)";
            PreparedStatement ps = con.prepareStatement(query);
            ps.setString(1, p_name);
            ps.setString(2, p_fname);
            ps.setString(3, p_mname);
            ps.setString(4, p_email);
            ps.setString(5, p_adharno);
            ps.setString(6, p_phoneno);
            ps.setString(7, p_address);
            ps.setString(8, p_course);
